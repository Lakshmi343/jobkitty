      ...
      <div className="container mx-auto px-4 py-12 relative z-10">
        ...
        <div className="mt-8 pt-8 border-t border-white/20 flex flex-col items-center justify-center space-y-4">
          ...
          <div className="flex items-center justify-center space-x-4">
            {/* Facebook */}
            <a 
              href="https://www.facebook.com/profile.php?id=61580790981145" 
              className="px-3 py-2 bg-[#1877f3] text-white rounded-full hover:bg-[#166fe5] transition-all duration-300 transform hover:scale-110 text-sm font-medium"
              aria-label="Facebook"
            >
              Facebook
            </a>
            ...
            {/* Instagram */}
            <a 
              href="https://www.instagram.com/jobkitty_official/"
              className="px-3 py-2 bg-[#E4405F] text-white rounded-full hover:bg-[#d73654] transition-all duration-300 transform hover:scale-110 text-sm font-medium"
            ...
            {/* LinkedIn */}
            <a 
              href="https://www.linkedin.com/in/admin-jobkitty-84241b383/" 
              className="px-3 py-2 bg-[#0077b5] text-white rounded-full hover:bg-[#006399] transition-all duration-300 transform hover:scale-110 text-sm font-medium"
              aria-label="LinkedIn"
            >
              LinkedIn
            </a>
